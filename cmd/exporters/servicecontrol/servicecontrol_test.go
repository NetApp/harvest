...
func setupInfluxDB(t *testing.T, exporterName string) *ServiceControl {
	opts := options.New()
	opts.IsTest = true
	...
	influx := &ServiceControl{AbstractExporter: exporter.New("ServiceControl", exporterName, opts, e, nil)}
