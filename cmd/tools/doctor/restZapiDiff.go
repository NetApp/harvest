...
func metricValueDiff(metricName string) {
	...
	environmentSensorMetrics := strings.Join([]string{"environment_sensor_power", "environment_sensor_average_ambient_temperature", "environment_sensor_min_ambient_temperature", "environment_sensor_max_temperature",
		"environment_sensor_average_temperature", "environment_sensor_min_temperature", "environment_sensor_average_fan_speed", "environment_sensor_max_fan_speed", "environment_sensor_min_fan_speed"},
		",")
