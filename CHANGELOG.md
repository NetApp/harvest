...
- :medal_sports: **Expanded E-Series support** — new pool, interface, workload, and application object collection; SSD cache support for older E-Series (SANtricity) versions; a new `rawCapacity` drive counter; and collector-level filtering.
