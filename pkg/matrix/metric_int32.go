...
func (me *MetricInt32) GetValueInt(i *Instance) (int, bool, bool) {
	return int(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueInt32(i *Instance) (int32, bool, bool) {
	return me.values[i.index], me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueInt64(i *Instance) (int64, bool, bool) {
	return int64(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueUint8(i *Instance) (uint8, bool, bool) {
	return uint8(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueUint32(i *Instance) (uint32, bool, bool) {
	return uint32(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueUint64(i *Instance) (uint64, bool, bool) {
	return uint64(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueFloat32(i *Instance) (float32, bool, bool) {
	return float32(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueFloat64(i *Instance) (float64, bool, bool) {
	return float64(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueString(i *Instance) (string, bool, bool) {
	return strconv.FormatInt(int64(me.values[i.index]), 10), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt32) GetValueBytes(i *Instance) ([]byte, bool, bool) {
