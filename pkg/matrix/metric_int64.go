...
func (me *MetricInt64) GetValueInt(i *Instance) (int, bool, bool) {
	return int(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueInt32(i *Instance) (int32, bool, bool) {
	return int32(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueInt64(i *Instance) (int64, bool, bool) {
	return me.values[i.index], me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueUint8(i *Instance) (uint8, bool, bool) {
	return uint8(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueUint32(i *Instance) (uint32, bool, bool) {
	return uint32(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueUint64(i *Instance) (uint64, bool, bool) {
	return uint64(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueFloat32(i *Instance) (float32, bool, bool) {
	return float32(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueFloat64(i *Instance) (float64, bool, bool) {
	return float64(me.values[i.index]), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueString(i *Instance) (string, bool, bool) {
	return strconv.FormatInt(me.values[i.index], 10), me.record[i.index], me.skip[i.index]
}

func (me *MetricInt64) GetValueBytes(i *Instance) ([]byte, bool, bool) {
