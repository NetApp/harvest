...
|------------------|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| `client_timeout` | Go duration    | how long to wait for server responses. This must cover streaming a whole `batch_size` page of events, not just the time to first byte, and this endpoint's response time varies by more than 10x for an identical query. Keep it below the `data` interval                                                                                                                                                                                                                     | 2m      |
