...
| `jitter`           | duration (Go-syntax), optional | By default, Harvest sends all performance object queries for a collector at nearly the same time or within close intervals. To spread out the collector startup times over a broader period, you can use jitter with a specified duration, such as one minute, to randomly distribute all object queries throughout that minute. Refer to [this discussion](https://github.com/NetApp/harvest/discussions/2856) for more details..                                                                                                                                                                                  |            |
