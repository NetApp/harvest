...
[prepare monitored clusters](/prepare-cdot-clusters/#all-apis-read-only-approach) for details)
...
ONTAP's full set of REST APIs by visiting `https://docs.netapp.com/us-en/ontap-automation/reference/api_reference.html#access-a-copy-of-the-ontap-rest-api-reference-documentation`
...
```json
{
  "records": [
    {
      ...
      "_links": {
        "self": {
          "href": "/api/storage/aggregates/3e59547d-298a-4967-bd0f-8ae96cead08c"
        }
      }
    },
    {
      ...
      "_links": {
        "self": {
          "href": "/api/storage/aggregates/c1931ba8-bb35-4b12-84dc-1e0643487144"
        }
      }
    }
  ],
  ...
  "_links": {
    "self": {
      "href": "/api/storage/aggregates?return_records=true&fields=*"
    }
  }
}
```
...
into: `name`, `space.block_storage.size`, `space.block_storage.available`, `state` and `volume_count`. Metric names will be taken, as is, unless you
...
- [Harvest configuration file](/configure-harvest-basic/#pollers) (default: `harvest.yml`)
...
| - `data`         | duration (Go-syntax) | how frequently this collector/object should retrieve metrics from ONTAP | 5 minutes |
...
Refer [metrics](/configure-zapi/#metrics_1)
...
Refer [Object configuration file](/configure-rest/#object-configuration-file)

#### `counters`

Refer [Counters](/configure-rest/#counters)
...
Refer [Export Options](/configure-rest/#export_options)
