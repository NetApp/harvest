...
| `collectors`           | **required**                                   | List of collectors to run for this poller. Possible values are `Zapi`, `ZapiPerf`, `Rest`, `RestPerf`, `KeyPerf`, `StatPerf`, `Ems`, `StorageGrid`, `CiscoRest`, `AristaRest`, `Eseries`, `EseriesPerf`, `EseriesMel`.                                                                                                                                                     |                  |
