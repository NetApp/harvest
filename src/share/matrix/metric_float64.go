...
func (m *MetricFloat64) SetValueInt(i *Instance, v int) error {
	m.record[i.index] = true
	m.values[i.index] = float64(v)
	return nil
}

func (m *MetricFloat64) SetValueInt32(i *Instance, v int32) error {
	m.record[i.index] = true
	m.values[i.index] = float64(v)
	return nil
}
...
func (m *MetricFloat64) SetValueUint32(i *Instance, v uint32) error {
	m.record[i.index] = true
	m.values[i.index] = float64(v)
	return nil
}
...
func (m *MetricFloat64) SetValueFloat32(i *Instance, v float32) error {
	m.record[i.index] = true
	m.values[i.index] = float64(v)
	return nil
}
...
func (m *MetricFloat64) GetValueInt32(i *Instance) (int32, bool) {
...
func (m *MetricFloat64) GetValueUint32(i *Instance) (uint32, bool) {
...
func (m *MetricFloat64) GetValueFloat32(i *Instance) (float32, bool) {
...
func (m *MetricFloat64) GetValueString(i *Instance) (string, bool) {
	return strconv.FormatFloat(m.values[i.index], 'f', -1, 64), m.record[i.index]
}
